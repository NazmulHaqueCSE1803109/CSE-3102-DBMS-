...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 20, 2022 at 04:09 AM
...
(3, 'Sayatajit Ray', 1921, 45, 55),
(4, 'Anjan Dutt', 1953, 23, 17),
(5, 'Ritupamo Ghosh', 1963, 20, 15),
...
--
ALTER TABLE `movie_character_relationship`
  ADD CONSTRAINT `movie_character_relationship_ibfk_1` FOREIGN KEY (`Movie_ID`) REFERENCES `movie` (`Movie_ID`);
COMMIT;
